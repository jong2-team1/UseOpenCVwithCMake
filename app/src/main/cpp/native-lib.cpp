...
Java_com_example_useopencvwithcmake_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
Java_com_example_useopencvwithcmake_MainActivity_detect(JNIEnv *env, jobject instance,
